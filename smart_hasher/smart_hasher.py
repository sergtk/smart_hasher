...
def handle_input_file(input_file_name) -> ExitCode:
    ...
    with open(output_file_name, 'w') as outputFile:
        ...
        if not cmd_line_args.suppress_output_file_comments:
            ...
            outputFile.write(f"# Hash algorithm: {cmd_line_args.hash_algo}\n")
        input_file_name_user = util.rel_file_path(input_file_name, output_file_name, cmd_line_args.use_absolute_file_names)
        outputFile.write(hash + " *" + input_file_name_user + "\n")
